...
model =
  ...
  bodies:
    ...
    ring7: ring(42.4,1,-65,[45,135,225,315],12,19.5,.8,.5,1,[17],45)
    ring8: ring(42.4,-1,-65,[45,135,225,315],12,19.5,.8,.5,1,[17],45+80)
    ...
    ring9: ring(0,-17.5,0,12,2,2,.1,.2,0,113,0)
    ring10: ring(0,-15,0,12,1.5,1.5,.2,.1,0,113,0)
    ring11: ring(0,-12.5,0,12,1,1,.2,.1,0,113,0)
    ring12: ring(16,11.5,0,12,2,2,.2,.1,0,113,60)    
    ring13: ring(16-5,11.5-2.7,0,12,1,1,.2,.1,0,113,60)    
    ring14: ring(16-2.5,11.5-1.35,0,12,1.5,1.5,.2,.1,0,113,60)    
    ...
    main:
      ...
      position:
        ...
        y: [-80,-80,-60,-60,-22,-20,-20,-20,34.5,34.5,36.5,50,51.5,70,68]
    ...
    head:
      section_segments: [0,30,90,150,180]
      offset:
        x: 0
        y: -16
        z: 0
      ...
      texture: [2]     
    head2:
      section_segments: [0,30,90,150,180].add(180)
      offset:
        x: 0
        y: -16
        z: 0
    ...
    head3:
      ...
      angle: 0      
    head4:
      section_segments: [-30,30,45,135,225,315]
      offset:
        x: 0.01
        y: -16
        z: 0
    ...
    box2:
      ...
      position:
        ...
        y: [-5,-1,1,1,1]
        z: [0,0,0,0,0]
      width: [5,7,5,3,3].div(1.5)
      height: [20,20,15,13,0].mult(1.3)
      texture: [4,17.95,17,15]      
    joint:
      section_segments: 6
      offset:
        x: 11
      ...
      position:
        ...
        y: [-2,0.7,2,2,-2,-2]
        z: [0,0,0,0,0,0]
      width: [6,6,6,4,4,6].mult(1.2)
      height: [6,6,6,4,4,6].mult(1.2)
      texture: [3.9,63,3.9] 
    joint2:
      section_segments: 6
      offset:
    ...
    box:
      ...
      position:
        ...
        z: [0,0,0,0,0]
      width: [0,3,3,1.8,0]
      height: [0,15,15,13.5,0].mult(1.2)
      texture: [63,4,63,17]
      angle: 30
      vertical: true    
    pipe:
      ...
      offset:
        ...
        z: 2
      position:
        x: [0,0,0,0,0,-.5,-1,-1.5,-2,0]
        y: [0,0,10,20,30,40,50,60,70]
        z: [0,0,0,0,0,0,-.5,-1,-3]
      width: [0,3,3,3,3,3,3,3,3,3]
      height: [0,3,3,3,3,3,3,3,3,]
      texture: [17,17,18,17,18,17,18,17]   
      angle: 36
    gap:
      section_segments: [45,135,225,315]
      offset:
    ...
    hubs:
      ...
      position:
        x: [0,0,0,0,0,0,0]
        y: [0,10,8,8,10,9].div(2)
        z: [0,0,0,0,0,0,0]
      width: [18,15,13,12,10,0].div(1.7)
      height: [18,15,13,12,10,0].div(1.7)
      texture: [11,18,17,18,18]      
    lights:
  ...
  wings: 
    main:
      ...
      offset:
        ...
        z: -10
      length: [45,0,1.5,6]
      width: [0,0,40,80,40].div(1.2)
      angle: [0,0,0,0]
      position: [20,30,-30,-30,10].div(1.2)
      texture: [0,4,17,63]
      bump:
        position: 75
        size: 17       
