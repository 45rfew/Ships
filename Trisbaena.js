...
return model =
  ...
  bodies:
    main:
      ...
      texture: [4,11,18.1,18.1,4,17,4,18.1,4,4,4,18,17,17,17,18,17,17,17,18,17,17,17,18,17,17,17,18,4,18.1,18.1,4,18.1,18.1,4,18.1,17,18,13]
      propeller: true
    front_spike:
    ...
    propeller1:
      ...
      position:
        ...
        y: [-10,-10,30,30,30,20]
        z: [0,0,0,0,0,0]
      width: [0,15,15,14,14,0]
      height: [0,15,15,14,14,0]
      propeller: true
      texture: [3,3,17,13]
    propeller2:
      section_segments: 10
